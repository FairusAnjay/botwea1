	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: '𝕱𝖆𝖎𝖗𝖚𝖟𝖟×፝֟͜×', //Kasih namalu
                            orderTitle: '𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×',
...
const fcon = {
	 ...
	 message: { "contactsArrayMessage": { "title":"𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×","h": `aloo`, 'jpegThumbnail': fs.readFileSync('./src/logo.jpg')}}
	}
const ftextt = {
	 key: { 
          fromMe: false,
...
const freply = {key:{ fromMe:false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: {
	...
	"productImageCount": 1
						...
						"businessOwnerJid": "6285649064565@s.whatsapp.net"}}}    
...
❏ ${petik} https://chat.whatsapp.com/CONEEVXvT8JCn4ZqYJVims ${petik} 
...
`
   ...
   conn.sendMessage(m.chat, text.trim(), 'extendedTextMessage', { detectLinks: true, thumbnail: ppnya, quoted: ftroli, contextInfo : { mentionedJid: conn.parseMention(text),
    ...
    externalAdReply: {
                    ...
                    mediaUrl: 'https://youtube.com/channel/UC0kxCB-Uci5et_Tz9PcrB6w'
