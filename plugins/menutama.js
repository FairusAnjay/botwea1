...
Ｓｕｂｓｃｒｉｂｅ
https://youtube.com/channel/UC0kxCB-Uci5et_Tz9PcrB6w
...
`.trim(),    footerText: 'JANGAN SPAM !! | | All Rights Reserved' ,
    buttons: buttons,
...
thumbnail: await (await require('node-fetch')(imeg)).buffer(),
    ...
    orderId: require('crypto').randomBytes(666).toString('hex').toUpperCase(), // Biar Ga ke detect bug troli
