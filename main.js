...
if (opts['test']) {
  ...
  conn.connect().then(() => {
 conn.sendMessage('6287834993722@c.us', 'Bot Telah Tersambung Ke Database 𝑭𝒂𝒊𝒓𝒖𝒔𝑩𝒐𝒕𝒛×፝֟͜×', 'conversation');
...
global.reloadHandler = function () {
  ...
  conn.spromote = 'Selamat Untuk @user Karna Sekarang Menjadi Admin Di Grup @subject !'
  conn.sdemote = 'Mampus :v @user Sekarang Bukan Admin Grup Lagi :v'
